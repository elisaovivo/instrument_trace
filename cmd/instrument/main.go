...
import (
	...
	"github.com/elisaovivo/instrument_trace/instrumenter"
	"github.com/elisaovivo/instrument_trace/instrumenter/ast"
)
...
func main() {
	...
	ins = ast.New("github.com/elisaovivo/instrument_trace", "trace", "Trace")
